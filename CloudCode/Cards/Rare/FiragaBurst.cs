...
public class FiragaBurst() : CloudCard(2, CardType.Attack,
    CardRarity.Rare, TargetType.AnyEnemy), IATBCard, IMagicCard
{
        ...
        CardPlay play)
    {
        ...
        AttackCommand attackCommand = await CommonActions.CardAttack(this, play.Target)
