...
public static class OperatorCardDisplayUI
{
    private const string NodeName = "Operator_UI";
    private const string ScenePath = "res://Cloud/scenes/OperatorCardDisplay.tscn";
